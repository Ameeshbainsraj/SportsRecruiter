...
from.views import login_view,admin_dashboard_main,team_dashboard_main,player_dashboard_main, homepage, team_profile_view,schedule_tryouts,view_tryouts, signup_view,signup_view_main,register_view
urlpatterns = [
